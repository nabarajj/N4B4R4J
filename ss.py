...
def randBuildvsskj():
    #END = '[FBAN/FB4A;FBAV/395.0.0.27.214;FBBV/426817936;FBDM/{density=1.75,width=720,height=1422};FBLC/en_GB;FBRV/428276664;FBCR/Nepal Telecom;FBMF/LGE;FBBD/lge;FBPN/com.facebook.katana;FBDV/LM-Q510N;FBSV/11;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    ua = f'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Safari/537.36 Edg/117.0.2045.60'
    return ua
...
..::::..::..:::::..::........:::..:::::..::..:::::..::..:::::..:::......::
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            NABARAJ 
\033[1;37m Facebook:            NABARAJ
\033[1;37m Github  :            NABARAJ
\033[1;37m Version :            0.6
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100091471120905')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
